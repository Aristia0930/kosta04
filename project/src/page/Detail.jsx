...
export const Detail =(props)=> {
    ...
    const onclickPrevBtn=()=>{
        setCurrentPage(currentPage === 0 ? props.url.length -1 : currentPage -1)
    }
  

    // NextBtn
    const onclickNextBtn=()=>{
        setCurrentPage(currentPage === props.url.length -1 ? 0 : currentPage +1)
        console.log(setCurrentPage)
    }

    useEffect(() => {
        const interval = setInterval(()=>{
            setCurrentPage((currentPage)=>(currentPage === props.url.length -1 ? 0 : currentPage +1));
            console.log('1')
        },2000);
            ...
            <main class="main_Detail">
                <section class="product">
                        <div class="left">
                            {/* 슬라이드 이미지 */}
                            <div class="slide">     
                                <div class="product_img" style={{ backgroundImage: `url(${props.url[currentPage]})`}}>
                                
                                    <div class="icon">
                                        <div class='icon_array'>
                                            <FaAngleLeft onClick={onclickPrevBtn} class="icon_left" />

                                            <FaAngleRight onClick={onclickNextBtn}class="icon_right" />
                                        </div>
                                    </div>
                                </div>
                            </div>
